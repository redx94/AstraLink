...
contract EnhancedDynamicESIMNFT is ERC721, Ownable {
    ...
    function mintESIM(uint256 _id, address _to, string memory metadata) external onlyOwner {
    ...
    function updateMetadata(uint256 _id, string memory _newMetadata) external {
